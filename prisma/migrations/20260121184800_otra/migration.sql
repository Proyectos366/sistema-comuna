...
CREATE TABLE "new_asistencia" (
    ...
    CONSTRAINT "asistencia_id_usuario_valido_fkey" FOREIGN KEY ("id_usuario_valido") REFERENCES "usuario" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_asistencia" ("borrado", "createdAt", "descripcion", "fecha_registro", "id", "id_curso", "id_formador", "id_modulo", "id_usuario", "id_vocero", "presente", "updatedAt") SELECT "borrado", "createdAt", "descripcion", "fecha_registro", "id", "id_curso", "id_formador", "id_modulo", "id_usuario", "id_vocero", "presente", "updatedAt" FROM "asistencia";
