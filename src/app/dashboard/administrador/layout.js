/**
 @fileoverview Layout principal para el dashboard del administrador. Este componente aplica estilos
 globales, define metadatos de la página y envuelve toda la interfaz con el proveedor de contexto
 de usuario. @module layouts/DashboardAdministradorLayout
*/
...
export const metadata = {
  title: "Administrador", // 3. Título de la página
  description: "Sistema de comunas contraloría, dashboard-administrador", // 4. Descripción para SEO
};

/**
 Layout del dashboard del administrador. Envuelve los componentes hijos con el contexto de usuario.
 @function DashboardAdministradorLayout
