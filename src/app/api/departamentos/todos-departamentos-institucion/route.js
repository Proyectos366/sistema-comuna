...
/**
  Maneja las solicitudes HTTP GET para obtener todos los departamentos de una institución.
  @async
  @function GET
  @returns {Promise<object>} - Una respuesta HTTP en formato JSON con los departamentos encontrados o un error.
*/
