...
export async function POST(request) {
  try {
    ...
    console.error(`Error interno crear archivo: ` + error);
...
//         process.cwd(),
//         `storage/instituciones/${validaciones.nombreInstitucion}/${validaciones.nombreDepartamento}/${validaciones.nombreEstante}/${validaciones.nombreCarpeta}`,
//       );
...
//       // 4.2. Intentar crear el archivo física
//       try {
//         fs.renameSync(storagePath, rutaFinal);

//       } catch (error) {
//         throw new Error(
//           "Error al crear archivo dentro de carpeta: " + error.message,
//         );
//       }
...
//     // 6. Condición de error al crear el archivo en la base de datos
//     if (!nuevoArchivo) {
//       await registrarEventoSeguro(request, {
//         tabla: "archivo",
//         accion: "ERROR_CREAR_ARCHIVO",
//         id_objeto: 0,
//         id_usuario: validaciones.id_usuario,
//         descripcion: "No se pudo crear el archivo",
//         datosAntes: null,
//         datosDespues: nuevoArchivo,
//       });

//       // Retorna una respuesta de error con un código de estado 400
//       return generarRespuesta("error", "Error, no se creo el archivo", {}, 400);
//     }

//     // 7. Condición de éxito: el archivo se creó correctamente
//     await registrarEventoSeguro(request, {
//       tabla: "archivo",
//       accion: "CREAR_ARCHIVO",
//       id_objeto: nuevoArchivo.id,
