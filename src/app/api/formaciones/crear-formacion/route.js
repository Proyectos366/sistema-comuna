...
/**
  Maneja las solicitudes HTTP POST para crear una nueva formación.
  @async@function POST
  @param {Request} request - Objeto de la solicitud que contiene los detalles de la formación a crear.
  @returns {Promise un error}.
*/
