...
export async function GET() {
  try {
    const municipios = [
      {
        nombre: "bolívar",
        serial: "ven-01-2025-est-04-mun-01",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "camatagua",
        serial: "ven-01-2025-est-04-mun-02",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "francisco linares alcántara",
        serial: "ven-01-2025-est-04-mun-03",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "girardot",
        serial: "ven-01-2025-est-04-mun-04",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "josé ángel lamas",
        serial: "ven-01-2025-est-04-mun-05",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "josé félix ribas",
        serial: "ven-01-2025-est-04-mun-06",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "josé rafael revenga",
        serial: "ven-01-2025-est-04-mun-07",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "libertador",
        serial: "ven-01-2025-est-04-mun-08",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "mario briceño iragorry",
        serial: "ven-01-2025-est-04-mun-09",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "san casimiro",
        serial: "ven-01-2025-est-04-mun-10",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "san sebastián",
        serial: "ven-01-2025-est-04-mun-11",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "santiago mariño",
        serial: "ven-01-2025-est-04-mun-12",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "sucre",
        serial: "ven-01-2025-est-04-mun-13",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "tovar",
        serial: "ven-01-2025-est-04-mun-14",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "urdaneta",
        serial: "ven-01-2025-est-04-mun-15",
        id_estado: 4,
        id_usuario: 1,
      },
      {
        nombre: "zamora",
        serial: "ven-01-2025-est-04-mun-16",
        id_estado: 4,
        id_usuario: 1,
      },
    ];
