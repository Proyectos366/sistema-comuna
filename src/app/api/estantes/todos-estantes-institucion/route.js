/**
 @fileoverview Controlador de API para la consulta de todos los estantes por institucion.
*/

// Importaciones de módulos y librerías
import prisma from "@/libs/prisma";
import { generarRespuesta } from "@/utils/respuestasAlFront";
import validarConsultarEstantesInstitucion from "@/services/estantes/validarConsultarEstantesInstitucion";
...
export async function GET() {
  try {
    // 1. Valida la operación de consulta
    const validaciones = await validarConsultarEstantesInstitucion();
    ...
    console.log(`Error interno consultar estantes institución: ` + error);
    return generarRespuesta(
      "error",
      "Error interno consultar estantes institución",
      {},
      500,
    );
  }
...
// /**
//  @fileoverview Controlador de API para la consulta de todos los estantes por institucion. Este
//  archivo maneja la lógica para obtener todos los registros de estantes en la base de datos a
...
// import validarConsultarEstantesInstitucion from "@/services/estantes/validarConsultarEstantesInstitucion"; // Servicio para validar la consulta de estantes.
