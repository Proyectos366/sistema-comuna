...
import validarConsultarEstantesDepartamento from "@/services/estantes/validarConsultarEstantesDepartamento"; // Servicio para validar la consulta de estantes.
...
export async function GET(request) {
  try {
    ...
    const validaciones = await validarConsultarEstantesDepartamento(request);
