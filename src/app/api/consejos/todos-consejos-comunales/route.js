...
servicio de validaciónpara asegurar la validez de la consulta.@module
*/
...
/**
Maneja las solicitudes HTTP GET para obtener todos los consejos comunales.@async@function GET@returns {Promise - Una respuesta HTTP en formato JSON con los consejos comunales encontrados o un error.
*/
export async function GET() {
  try {
    ...
    // 3. Consulta todos los consejos comunales en la base de datos
