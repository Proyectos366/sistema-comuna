...
export default function ModalPrincipal({
  ...
  return (
    <Div className="fixed inset-0 flex items-center justify-center z-50 px-2 sm:px-0">
      ...
      <Div className="relative flex justify-center items-center bg-white rounded-md shadow-xl px-1 sm:px-6 py-6 max-w-lg w-full border border-gray-300 transition-transform transform hover:scale-105">
        <Button
          nombre={"x"}
