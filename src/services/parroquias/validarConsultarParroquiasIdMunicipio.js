/**
 ...
 de todos las Parroquias por idMunicipio.
 @module services/parroquias/validarConsultarParroquiasIdMunicipio
*/
...
/**
 Valida la identidad del usuario que intenta consultar todas las Parroquias por municipio.
 @async
 @function validarConsultarParroquiasIdMunicipio
 @returns {Promise<Object>} Respuesta estructurada con el resultado de la validación.
*/
export default async function validarConsultarParroquiasIdMunicipio(request) {
  try {
    ...
    console.log(
      "Error interno validar consultar parroquias idMunicipio: " + error
    );

    // Retorna una respuesta del error inesperado
    return retornarRespuestaFunciones(
      "error",
      "Error interno validar consultar parroquias idMunicipio"
    );
  }
}
