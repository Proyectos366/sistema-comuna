/**
 ...
 antes de permitir la consulta de todos los cursos registrados en el sistema.
 @module services/cursos/validarConsultarTodosCursos
*/
...
/**
 Valida si el usuario tiene permisos suficientes para consultar todos los cursos.
 Solo los usuarios con rol 1 (administrador) tienen acceso autorizado.
 @async
 @function validarConsultarTodosCursos
 @returns {Promise<Object>} Respuesta estructurada con el resultado de la validación.
*/

export default async function validarConsultarTodosCursos() {
  try {
    ...
    console.log("Error interno validar consultar todos cursos: " + error);

    // Retorna una respuesta del error inesperado
    return retornarRespuestaFunciones(
      "error",
      "Error interno validar consultar todos cursos",
    );
  }
}
