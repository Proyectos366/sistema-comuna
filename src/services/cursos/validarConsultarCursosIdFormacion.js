/**
 ...
 antes de consultar los cursos.
 @module services/cursos/validarConsultarCursosIdFormacion
*/
...
/**
 Valida la identidad del usuario y el ID de la formacion para consultar cursos.
 @async
 @function validarConsultarCursosIdFormacion
...
export default async function validarConsultarCursosIdFormacion(request) {
  try {
    ...
    console.log(`Error interno validar consultar cursos idFormacion: ` + err);

    // Retorna una respuesta del error inesperado
    return retornarRespuestaFunciones(
      "error",
      "Error interno validar consultar cursos idFormacion",
    );
  }
}
