/**
 ...
 y los parámetros necesarios antes de eliminar (desactivar) un consejo comunal en el sistema.
 @module services/comunas/validarEliminarConsejoComunal
*/
...
/**
 Valida la identidad del consejo comunal, sus permisos y los parámetros requeridos para eliminar
 (desactivar) otro consejo. Verifica que el estado sea booleano y que el ID del consejo comunal
 objetiva sea válido.
 @async
 @function validarEliminarConsejoComunal
 @param {boolean} estado - Estado booleano que indica si se debe eliminar.
 @param {string|number} idConsejo - Identificador único del consejo comunal a eliminar.
 @returns {Promise<Object>} Respuesta estructurada con el resultado de la validación.
*/
export default async function validarEliminarConsejoComunal(estado, idConsejo) {
  try {
    ...
    console.log("Error interno validar eliminar consejo: " + error);

    // Retorna una respuesta del error inesperado
    return retornarRespuestaFunciones(
      "error",
      "Error interno validar eliminar consejo"
    );
  }
}
