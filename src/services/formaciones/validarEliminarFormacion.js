/**
 ...
 y los parámetros necesarios antes de eliminar (desactivar) una formacion en el sistema.
 @module services/formaciones/validarEliminarFormacion
*/
...
/**
 Valida la identidad de la formacion, sus permisos y los parámetros requeridos para eliminar
 (desactivar) otra formacion. Verifica que el estado sea booleano y que el ID de la formacion
 objetiva sea válido.
 @async
 @function validarEliminarFormacion
 @param {boolean} estado - Estado booleano que indica si se debe eliminar.
 @param {string|number} idFormacion - Identificador único de la formacion a eliminar.
 @returns {Promise<Object>} Respuesta estructurada con el resultado de la validación.
*/
export default async function validarEliminarFormacion(estado, idFormacion) {
  try {
    ...
    console.log("Error interno validar eliminar formacion: " + error);

    // Retorna una respuesta del error inesperado
    return retornarRespuestaFunciones(
      "error",
      "Error interno validar eliminar formacion"
    );
  }
}
