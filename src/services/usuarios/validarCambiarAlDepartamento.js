/**
 ...
 y los parámetros necesarios antes de cambiar a otro usuario de departamento.
 @module services/departamentos/validarCambiarAlDepartamento
*/
...
/**
 ...
 y verifica que el usuario aún no pertenezca al departamento antes de realizar el cambio.
 @async
 @function validarCambiarAlDepartamento
 @param {string|number} idDepartamento - Identificador del departamento al que se desea mover al usuario.
 @param {string|number} idUsuario - Identificador del usuario que será asignado al nuevo departamento.
...
export default async function validarCambiarAlDepartamento(
  ...
  try {
    ...
    // 5. Validar el ID del usuario que será reasignado.
