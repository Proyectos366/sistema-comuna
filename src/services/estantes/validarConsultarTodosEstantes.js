/**
 ...
 de todos los estantes disponibles. @module services/estantes/validarConsultarTodosEstantes
*/
...
/**
 ...
 @async
 @function validarConsultarTodosEstantes
 @returns {Promise<Response>} Respuesta estructurada con el resultado de la validación.
*/

export default async function validarConsultarTodosEstantes() {
  try {
    ...
    // 4. Si todas las validaciones son correctas, se consolidan y retornan los datos del usuario.
    ...
    console.log(`Error interno validar consultar todos estantes: ` + error);

    // Retorna una respuesta del error inesperado
    return retornarRespuestaFunciones(
      "error",
      "Error interno validar consultar todos estantes",
    );
  }
}
