/**
 ...
 de consultar los estantes.
 @module services/estantes/validarConsultarEstantesIdDepartamento
*/
...
/**
 Valida la identidad del usuario y el ID del departamento para consultar estantes.
 @async
 @function validarConsultarEstantesIdDepartamento
...
*/
export default async function validarConsultarEstantesIdDepartamento(request) {
  try {
    ...
    console.log(
      `Error interno validar consultar estantes id departamento: ` + error,
    );

    // Retorna una respuesta del error inesperado
    return retornarRespuestaFunciones(
      "error",
      "Error interno validar consultar estantes id departamento",
    );
  }
}
